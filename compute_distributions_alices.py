...
Marta Silva (LIP/IST/CERN-ATLAS), 28/11/2023
"""
...
if __name__ == '__main__':
    ...
    for channel in args.channel:
        ...
        if args.plot_alices:
            alices_plot = plot_alices(f"{args.main_dir}/models/{args.alices_observables}/{args.alices_model}/alices_ensemble_{channel}_{args.sample_type}", args, channel)
