...
if __name__ == "__main__":
  ...
  parser.add_argument('--observable_set',help="using full (including unobservable degrees of freedom) or met (only observable degrees of freedom) observable set",required=True,choices=['full','met', "parton_level_validation"])
